...
function handleSetupSucceeded(event) {
    ...
    try {
        ...
        steps.forEach(stepData => {
            ...
            taskValidations.querySelector(`#${TASK_VALIDATIONS_ACCORDION_ID}`).appendChild(buildSREAccordionItem(
            id, stepResult, title, description));
        });
    } catch (error) {
