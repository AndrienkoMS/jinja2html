...
//              check that json is valid and parse back to have proper endlines instead of "\n"
                body.innerHTML = JSON.parse(JSON.stringify(stepData.meta, null, 2));
...
const buildAccordionItem = function (id, result, title, description) {
    let color = result === 'success' ? BG_SUCCESS_SUBTLE : BG_DANGER_SUBTLE;
//    let color;
//    if (result === 'success') {
//        color = BG_SUCCESS_SUBTLE;
//    } else {
//        color = BG_DANGER_SUBTLE;
//    }
